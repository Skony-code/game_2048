# gui.py
"""Simple object oriented gui library

The library is designed to make it very easy for novice programmers to
experiment with computer gui in an object oriented fashion. It is
...
#     Cleaned up handling of exceptions in Tk thread. The gui package
...
#        the window are done after each action. This makes some gui
...
class GraphicsError(Exception):
    """Generic error class for gui module exceptions."""
    pass
...
class GraphWin(tk.Canvas):
    ...
    """A GraphWin is a toplevel window for displaying gui."""
